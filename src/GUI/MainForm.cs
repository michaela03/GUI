	...
	public partial class MainForm : Form
	{
        ...
        private void ColorDialogButton_Click(object sender, EventArgs e)
        {
			if (colorDialog1.ShowDialog() == DialogResult.OK)
			{
				...
				if (dialogProcessor.Selection != null)
				dialogProcessor.Selection.FillColor = pickedColor;
				viewPort.Invalidate();
			}
        }
        ...
        private void trackBar1_ValueChanged(object sender, EventArgs e)
        {
			...
			if (dialogProcessor.Selection != null)
				dialogProcessor.Selection.FillColorOpacity = 
					trackBar1.Value;
		viewPort.Invalidate();	
        }
        ...
        private void MainColor_Click(object sender, EventArgs e)
        {
            ...
            {
                Color pickedColor = colorDialog1.Color;
                OffColor.BackColor = pickedColor;
                viewPort.Invalidate();
            }
        }

        private void OffColor_Click(object sender, EventArgs e)
        {
            if (colorDialog1.ShowDialog() == DialogResult.OK)
            {
                Color pickedColor = colorDialog1.Color;
